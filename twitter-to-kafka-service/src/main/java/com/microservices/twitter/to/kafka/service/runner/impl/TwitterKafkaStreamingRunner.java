...
public class TwitterKafkaStreamingRunner implements StreamRunner {
    ...
    public TwitterKafkaStreamingRunner(TwitterToKafkaServiceConfigData twitterToKafkaServiceConfigData, TwitterKafkaStatusListener twitterKafkaStatusListener) {
